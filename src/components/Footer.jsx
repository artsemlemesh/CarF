    ...
    <footer className="bg-gray-800 text-gray-200 py-8">
      <div className="container mx-auto grid md:grid-cols-4 sm:grid-cols-1 gap-8">
        ...
        <div>
          ...
          <p className="mb-4">
            Your reliable car rental service offering a wide range of vehicles
            to suit your needs. Explore the city with comfort and style.
          </p>
        ...
        <div>
          ...
          <p className="mb-4">
            Email:{" "}
            <a href="mailto:info@carrentals.com" className="hover:underline">
              info@carrentals.com
            </a>
          </p>
          <p className="mb-4">
